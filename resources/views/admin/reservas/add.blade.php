                            ...
                            <tbody>
                                @foreach( $reservas as $reserva )
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('reservas_edit',[ 'id' =>  $reserva->id ]) }}" class="btn btn-info"><i class="material-icons-outlined">edit</i></a>
                                            <a href="{{ url('reservas_delete',[ 'id' =>  $reserva->id ]) }}" class="btn btn-danger" onclick="return confirm('¿Estás seguro de que deseas eliminar esta reserva?');"><i class="material-icons-outlined">delete</i></a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
