                            ...
                            <tbody>
                                @foreach( $directorios as $directorio )
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('directorios_edit',[ 'id' =>  $directorio->id ]) }}" class="btn btn-info"><i class="material-icons-outlined">edit</i></a>
                                            <a href="{{ url('directorios_delete',[ 'id' =>  $directorio->id ]) }}" class="btn btn-danger" onclick="return confirm('¿Estás seguro de que deseas eliminar este directorio?');"><i class="material-icons-outlined">delete</i></a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
