                            ...
                            <tbody>
                                @foreach( $tarifas_conjunto as $tarifas )
                                    <tr>
                                        ...
                                        <td>{{ $tarifas->valor }}</td>
                                        <td>
                                            <a href="{{ url('tarifas_conjunto_edit',[ 'id' =>  $tarifas->id ]) }}" data-bs-toggle="tooltip" data-bs-offset="0,8" data-bs-placement="top" data-bs-custom-class="tooltip-primary" title="Editar tarifas"  class="btn btn-info"><i class="fa fa-pencil"></i></a>
                                            <a href="{{ url('tarifas_conjunto_delete',[ 'id' =>  $tarifas->id ]) }}" data-bs-toggle="tooltip" data-bs-offset="0,8" data-bs-placement="top" data-bs-custom-class="tooltip-primary" title="Eliminar Visitante" class="btn btn-danger" onclick="return confirm('¿Estás seguro de que deseas eliminar este registro?');"><i class="fa fa-trash"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
