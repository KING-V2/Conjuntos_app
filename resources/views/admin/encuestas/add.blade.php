                                        ...
                                        <tbody>
                                            @foreach( $encuestas->where('mes',$mes_actual) as $encuesta )
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="col-md-12"><a href="{{ url('encuestas_edit',[ 'id' =>  $encuesta->id ]) }}" class="btn btn-info form-control mb-2"><i class="fa fa-pencil"></i></a></div>
                                                        <!-- <div class="col-md-12"><a href="{{ url('encuestas_delete',[ 'id' =>  $encuesta->id ]) }}" class="btn btn-danger form-control mb-2" onclick="return confirm('¿Estás seguro de que deseas eliminar esta encuesta?');"><i class="fa fa-trash"></i></a></div> -->
                                                        <div class="col-md-12"><a class="btn btn-success form-control" data-bs-toggle="modal" data-bs-target="#resultadoModal" onclick="mostrarEstadisticas({{ $encuesta->id }});"><i class="fa fa-eye"></i></a></div>
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </tbody>
