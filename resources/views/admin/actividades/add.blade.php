                                        ...
                                        <tbody>
                                            @foreach( $actividades->where('mes', $mes_actual ) as $actividad )
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ url('actividades_edit',[ 'id' =>  $actividad->id ]) }}" class="btn btn-info"><i class="material-icons-outlined">edit</i></a>
                                                        <a href="{{ url('actividades_delete',[ 'id' =>  $actividad->id ]) }}" class="btn btn-danger" onclick="return confirm('¿Estás seguro de que deseas eliminar esta actividad?');"><i class="material-icons-outlined">delete</i></a>
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </tbody>
