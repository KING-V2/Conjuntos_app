                            ...
                            <tbody>
                                @foreach( $zonas_comunes as $zona_comun )
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('zonas_comunes_edit',[ 'id' =>  $zona_comun->id ]) }}" class="btn btn-info"><i class="material-icons-outlined">edit</i></a>
                                            <a href="{{ url('zonas_comunes_delete',[ 'id' =>  $zona_comun->id ]) }}" class="btn btn-danger" onclick="return confirm('¿Estás seguro de que deseas eliminar esta zona comun?');"><i class="material-icons-outlined">delete</i></a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
