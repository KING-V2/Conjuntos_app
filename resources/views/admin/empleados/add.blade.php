                                            ...
                                            <tbody>
                                                @foreach( $empleados->where('puesto',$puesto ) as $empleado )
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="{{ url('empleados_edit',[ 'id' =>  $empleado->id ]) }}" class="btn btn-info mb-2"><i class="fa fa-pencil"></i></a>
                                                            <a href="{{ url('empleados_delete',[ 'id' =>  $empleado->id ]) }}" class="btn btn-danger" onclick="return confirm('¿Estás seguro de que deseas eliminar este empleado?');"><i class="fa fa-trash"></i></a>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
