                        ...
                        <tbody>
                            @foreach ($categoria_vehiculos as $categoria_vehiculo)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ url('categoria_vehiculo_edit', $categoria_vehiculo->id) }}" class="btn btn-warning"> <i class="fa fa-pencil"></i> </a>
                                        <form action="{{ url('categoria_vehiculo_delete', []) }}" method="POST" style="display:inline;">
                                            ...
                                            <button type="submit" class="btn btn-danger" onclick="return confirm('¿Estás seguro de eliminar esta categoría?')"><i class="fa fa-trash"></i></button>
                                        </form>
                                    </td>
                                </tr>
                            @endforeach
