                            ...
                            <tbody>
                                @foreach( $galerias as $galeria )
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('galeria_conjunto_edit',[ 'id' =>  $galeria->id ]) }}" class="btn btn-info"><i class="material-icons-outlined">edit</i></a>
                                            <a href="{{ url('galeria_conjunto_delete',[ 'id' =>  $galeria->id ]) }}" class="btn btn-danger" onclick="return confirm('¿Estás seguro de que deseas eliminar este elemento?');"><i class="material-icons-outlined">delete</i></a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
