                                ...
                                @foreach( $parqueadero_visitantes as $parqueadero_visitante )
                                    <tr>
                                        ...
                                        @if( !$parqueadero_visitante->hora_salida )
                                            <a href="{{ url('parqueadero_visitante_edit',[ 'id' =>  $parqueadero_visitante->id ]) }}" class="btn btn-info"><i class="material-icons-outlined">edit</i></a>
                                            <a href="{{ url('parqueadero_visitante_delete',[ 'id' =>  $parqueadero_visitante->id ]) }}" class="btn btn-danger" onclick="return confirm('¿Estás seguro de que deseas eliminar este manual?');"><i class="material-icons-outlined">delete</i></a>
