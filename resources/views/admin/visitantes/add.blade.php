                            ...
                            <tbody>
                                @foreach( $visitantes as $visitante )
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('visitantes_edit',[ 'id' =>  $visitante->id ]) }}" data-bs-toggle="tooltip" data-bs-offset="0,8" data-bs-placement="top" data-bs-custom-class="tooltip-primary" title="Editar Visitante"  class="btn btn-info"><i class="material-icons-outlined">edit</i></a>
